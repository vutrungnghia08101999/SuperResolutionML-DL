...
logging.basicConfig(filename='logs/train_SRResNet.txt',
                    filemode='w',
...
parser.add_argument('--models_dir', type=str, default='models/SRResNet')
parser.add_argument('--weights', type=str, default='')
parser.add_argument('--images', type=str, default='experiments/SRResNet/train')
